---
title: Permissions
description: How Irminsul decides who can run member, setup, audit, protection, and manual moderation commands.
---
...
| Owner, Manage Server, or a recognized moderator capability | `/Auto-Fetch`, emoji mode, audit-log configuration/testing and privacy exclusions, restart, `/Server-Info`, Post Gate Protection configuration, Post Gate configuration, `/Level`, `/Get-Info` |
| Ban Members                                                | `/Ban`, `/Post-Gate protection approve`                                                                                                                                                        |
| Kick Members                                               | `/Kick`                                                                                                                                                                                        |
| Timeout Members                                            | `/Mute`, `/Post-Gate protection release`                                                                                                                                                       |
...
## Protection approval is stricter

Post Gate Protection configuration uses the broader moderator policy. A permanent-ban approval requires the server owner, **Manage Server**, or **Ban Members**. Manage Messages alone cannot approve a ban.
