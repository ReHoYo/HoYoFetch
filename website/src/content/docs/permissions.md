...
| Owner, Manage Server, or a recognized moderator capability | Auto-fetch, emoji mode, audit-log configuration/testing and privacy exclusions, restart, automod configuration |
