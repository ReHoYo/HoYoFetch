...
| Owner, Manage Server, or a recognized moderator capability | Auto-fetch, emoji mode, audit-log configuration/testing and privacy exclusions, restart, `/Server-Info`, automod configuration, post-gate configuration, `/Get-Info` |
