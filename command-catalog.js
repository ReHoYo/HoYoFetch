...
export const COMMAND_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    notes: [
      ...
      "Releasing a member (🔓 or `/Post-Gate release @member`) also marks them exempt from every automatic hold trigger going forward, until a moderator manually holds them again with `/Post-Gate hold` or 🔒 Deny + Hold User.",
  ...
  },
  {
    ...
    notes: [
      "Approving clears the author and resets their protection strike; it does not repost the held content, which the author may post again themselves.",
      "Rejecting discards the held content and increases the author's protection strike stage; it does not apply a timeout by itself.",
      "Deny + Hold User (🔒) also places the author in Post Gate, so every later message they send is held until a moderator releases them. A persistent control card in the review channel records who held them and when. If the author was previously released and exempt from automatic screening, this revokes that exemption.",
      "Release (🔓 or `/Post-Gate release @member`) restores normal posting straight away; messages already in the review queue stay queued and are reviewed individually. It also marks the author permanently exempt from automatic contact-solicitation, prohibited-identity, and first-post link/media triggers, until a moderator manually holds them again.",
      ...
      "`/Post-Gate hold @member <reason>` manually places a member in full Post Gate without waiting for an automatic trigger, and revokes any standing release exemption the same way Deny + Hold User does.",
    ],
  },
  {
