...
export const COMMAND_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    notes: [
      ...
      "Approving a held post (✅), or releasing a full account hold (🔓 or `/Post-Gate release @member`), marks the author exempt from contact-solicitation, prohibited-identity, and first-post link/media screening going forward — the slur filter still applies — until a moderator manually holds them again with `/Post-Gate hold` or 🔒 Deny + Hold User.",
  ...
  },
  {
    ...
    notes: [
      ...
      "Release (🔓 or `/Post-Gate release @member`) restores normal posting straight away; messages already in the review queue stay queued and are reviewed individually. It grants the same standing exemption approving does, until a moderator manually holds them again.",
